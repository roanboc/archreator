...
| 4 | `process-and-capability-levels` | A presentation pattern per level — the map, the contract, the flow — as a reference beside the content contract, covering the other leveled catalogues too | decided 2026-08-31 — applied in this change as `references/presentation-patterns.md` |
