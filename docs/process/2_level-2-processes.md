...
by` is the [grounding rule](../../plugins/archreator/skills/core-architecture-doc-style/SKILL.md)
...
and
[`discover-process-and-capability-levels`](../../plugins/archreator/skills/discover-process-and-capability-levels/SKILL.md)
are rules every process above complies with, and
[`flow-stack-selection`](../../plugins/archreator/skills/flow-stack-selection/SKILL.md)
...
it, and what must be in context when it does. `core-architecture-first-change` spans
