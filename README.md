...
| **Nothing to operate** | No database, no server, no export, no account. Markdown in git is the model |
...
from it. That single choice is why there's no export step and nothing to keep
running.
